...
## Tools
  ...
  * [DevProjex](https://github.com/Avazbek22/DevProjex) - A cross-platform .NET codebase-context suite with GUI, TUI, CLI, and a built-in read-only MCP server using the official C# MCP SDK.
